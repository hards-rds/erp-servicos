...
const statusMessages: Record<string, { kind: "success" | "error"; text: string }> = {
  ...
  cancelled: { kind: "success", text: "Entrada financeira cancelada e preservada no historico." },
  cancel_invalid: { kind: "error", text: "Nao foi possivel identificar a entrada para cancelar." },
  cancel_not_found: { kind: "error", text: "Entrada nao encontrada na empresa ativa." },
  cancel_settled: { kind: "error", text: "Entradas recebidas ou conciliadas nao podem ser canceladas." },
  cancel_nfse: { kind: "error", text: "Cancele primeiro a NFS-e ativa. O cancelamento fiscal tambem cancelara o boleto e esta entrada." },
  cancel_charge: { kind: "error", text: "Existe um boleto real ativo ou liquidado. Cancele a cobranca antes de cancelar a entrada." },
  cancel_check_error: { kind: "error", text: "Nao foi possivel conferir os vinculos desta entrada." },
  cancel_error: { kind: "error", text: "Nao foi possivel cancelar a entrada agora." },
