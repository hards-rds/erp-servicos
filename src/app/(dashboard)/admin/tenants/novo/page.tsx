        ...
        {!allowed ? <div className="form-error">Acesso restrito ao administrador do sistema.</div> : (
          <form className="form-stack" action="/api/admin/tenants" method="post">
            <div className="form-grid">
              ...
              <label>Segmento<select name="serviceSegment" defaultValue="tecnologia"><option value="tecnologia">Tecnologia</option><option value="otica">Otica</option><option value="escola_futebol">Escola de futebol</option><option value="transportadora">Transportadora</option><option value="generico">Generico</option></select></label>
